...
public final class FragmentMarketCategoryToyBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentMarketCategoryToyBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentMarketCategoryToyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMarketCategoryToyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_market_category_toy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMarketCategoryToyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMarketCategoryToyBinding((ConstraintLayout) rootView, imageView10,
