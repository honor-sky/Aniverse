...
public final class FragmentMarketCategoryAllBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentMarketCategoryAllBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentMarketCategoryAllBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMarketCategoryAllBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_market_category_all, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMarketCategoryAllBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMarketCategoryAllBinding((ConstraintLayout) rootView, imageView10,
