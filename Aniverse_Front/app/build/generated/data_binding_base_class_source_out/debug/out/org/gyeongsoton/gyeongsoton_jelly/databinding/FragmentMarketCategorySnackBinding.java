...
public final class FragmentMarketCategorySnackBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentMarketCategorySnackBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentMarketCategorySnackBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMarketCategorySnackBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_market_category_snack, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMarketCategorySnackBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMarketCategorySnackBinding((ConstraintLayout) rootView, imageView10,
