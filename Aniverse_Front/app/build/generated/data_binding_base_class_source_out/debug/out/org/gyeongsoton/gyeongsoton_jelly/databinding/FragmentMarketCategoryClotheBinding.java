...
public final class FragmentMarketCategoryClotheBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentMarketCategoryClotheBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentMarketCategoryClotheBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMarketCategoryClotheBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_market_category_clothe, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMarketCategoryClotheBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMarketCategoryClotheBinding((ConstraintLayout) rootView, imageView10,
