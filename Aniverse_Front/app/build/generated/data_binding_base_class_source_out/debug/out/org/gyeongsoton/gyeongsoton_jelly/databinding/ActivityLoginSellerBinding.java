...
public final class ActivityLoginSellerBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLoginSellerBinding(@NonNull FrameLayout rootView, @NonNull ImageButton backBtn,
  ...
  @NonNull
  public static ActivityLoginSellerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLoginSellerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_login_seller, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLoginSellerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginSellerBinding((FrameLayout) rootView, backBtn, centerbtn, loginButton,
          marketCode, normalbtn, sellerbtn, signupBtn, textView2);
    }
