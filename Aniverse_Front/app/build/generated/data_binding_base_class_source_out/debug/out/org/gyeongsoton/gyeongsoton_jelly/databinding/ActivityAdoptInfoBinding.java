...
public final class ActivityAdoptInfoBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView adoptend;
  ...
  private ActivityAdoptInfoBinding(@NonNull RelativeLayout rootView, @NonNull TextView Vacci,
      @NonNull TextView adoptcondition, @NonNull TextView adoptend, @NonNull TextView age,
      @NonNull TextView animalInformation, @NonNull TextView animalfind,
      @NonNull TextView animalintro, @NonNull ImageButton backBtn,
      ...
      @NonNull FrameLayout frameLayout, @NonNull ImageView img, @NonNull Button requestBtn,
      @NonNull TextView speciesGenderNeu, @NonNull TextView textView, @NonNull TextView weight) {
    this.rootView = rootView;
    this.Vacci = Vacci;
    this.adoptcondition = adoptcondition;
    this.adoptend = adoptend;
    this.age = age;
  ...
  @NonNull
  public static ActivityAdoptInfoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAdoptInfoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_adopt_info, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAdoptInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.adoptend;
      TextView adoptend = ViewBindings.findChildViewById(rootView, id);
      if (adoptend == null) {
        break missingId;
      }
      ...
      return new ActivityAdoptInfoBinding((RelativeLayout) rootView, Vacci, adoptcondition,
          adoptend, age, animalInformation, animalfind, animalintro, backBtn, centerImformation,
          centeraddress, centername, centerphoneNum, dises, frameLayout, img, requestBtn,
