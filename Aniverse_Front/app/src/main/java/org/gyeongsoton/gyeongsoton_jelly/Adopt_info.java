...
public class Adopt_info extends AppCompatActivity {
    ...
    String animalImage,animalSpecies,animalAge,animalGender,animalNeutralization,animalWeight,animalVaccinated,animalDiseases,
            animalFind,animalIntro,adoptEnd,centerName,centerAddress,centerPhoneNum,adoptCondition,animalIdx,userIdx,userAuth;

    private ImageView img;
    private TextView species_gender_neu,age,weight,Vacci,dises,animalfind,animalintro,adoptend,adoptcondition,centername,centeraddress,centerphoneNum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // userIdx="28";
        ...
        //adoptend = findViewById(R.id.adoptend);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success) {
                        ...
                        //동물정보 셋팅
                        Glide.with(Adopt_info.this).load(animalImage).into(img); //사진
                        ...
                        //doptend.setText("입양마감일: "+adoptEnd);//입양마감일
        ...
        adoptInfo_Request adoptinfo_Request = new adoptInfo_Request("2", responseListener); //입양 진행중
        RequestQueue queue = Volley.newRequestQueue(Adopt_info.this );
        queue.add(adoptinfo_Request);
...
/*
        ...
        back_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent( Adopt_info.this, Adopt_list.class );
                startActivity( intent );
            }
        });
*/
