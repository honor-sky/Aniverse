    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        normalbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Login_seller.this, Login_normal.class);
        ...
        centerbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Login_seller.this, Login_center.class);
                startActivity(intent);
            }
        });
        ...
        sellerbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Login_seller.this, Login_seller.class);
                startActivity(intent);
            }
        });
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Login_seller.this, Mypage.class);
                startActivity(intent);
            }
        });
        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {//로그인 성공시
                                ...
                                Intent intent = new Intent(Login_seller.this, Mypage.class); //로그인 성공시 마이페이지로 화면 전환
                                //화면 전환 시 전달되는 값들
                ...
                RequestQueue queue = Volley.newRequestQueue( Login_seller.this );
