module.exports = function(app){
    ...
    app.get('/adopt/list', adopt.getAdoptlist);

    // // 3.  activity_adopt_info.xml 사진눌렀을시 정보조회 API
    // app.get('/adopt/imgclick', adopt.getImgClick);
    //
    // // 4. activity_adopt_request.xml : 입양신청위한 정보 업로드 API
    // app.post('/adopt/userinfo', adopt.postUserInfo);
    //
    // //5. activity_adopt_monitoring_upload.xml : 후기(모니터링)글 업로드
    // app.post('/adopt/review', adopt.postReview);
    //
    // //6. activity_adopt_monitor.xml 후기(모니터링)글 : 검진결과, 소식 조회
